...
class LocalizacaoGeografica():
    ...
    def dist(self, objLocGeo):
        if not isinstance(objLocGeo, LocalizacaoGeografica):
            raise Exception ("Tipo inválido")
        
        R = 6372.8 # Earth radius in kilometers
        
        lat1 = self._get_latitude()
        lat2 = objLocGeo._get_latitude()
        
        lon1 = self._get_longitude()
        lon2 = objLocGeo._get_longitude()
